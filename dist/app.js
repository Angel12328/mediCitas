...
export function buildApp(options = {}) {
    const { mailer = new ConsoleMailer(), enableDocs = true, rateLimitMax = 300, authRateLimitMax = 10, } = options;
    const app = Fastify({
    ...
    if (enableDocs) {
        app.register(swagger, {
            openapi: {
                info: {
                    title: 'mediCitas API',
                    description: 'API de gestión de citas médicas: usuarios, pacientes, doctores, horarios y citas.',
                    version: '0.1.0',
                },
