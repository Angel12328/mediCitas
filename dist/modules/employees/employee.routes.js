...
import { assignCargoSchema, createEmployeeSchema, employeeIdParamSchema, employeeQuerySchema, updateEmployeeSchema, } from './employee.schemas.js';
...
export async function employeeRoutes(app) {
    ...
    app.post('/', { preHandler: [...adminOnly, validate({ body: createEmployeeSchema })] }, async (request, reply) => {
    ...
    app.get('/', { preHandler: [...adminOnly, validate({ query: employeeQuerySchema })] }, async (request) => {
    ...
    app.get('/:id/cargos', { preHandler: [...adminOnly, validate({ params: employeeIdParamSchema })] }, async (request) => {
        const { id: employeeId } = request.params;
        await requireEmployee(employeeId);
