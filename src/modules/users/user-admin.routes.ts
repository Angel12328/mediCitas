// Rutas de administración de usuarios y roles - mediCitas API
...
export async function userAdminRoutes(app: AnyFastifyInstance): Promise<void> {
  // ==================== ROLES ====================
  ...
  app.post(
    '/roles',
    { preHandler: [...adminOnly, validate({ body: createRoleSchema })] },
    async (request, reply) => {
  ...
  app.patch(
    '/roles/:id',
    { preHandler: [...adminOnly, validate({ body: updateRoleSchema })] },
    async (request) => {
  ...
  app.post(
    '/users',
    { preHandler: [...adminOnly, validate({ body: createAdminUserSchema })] },
    async (request, reply) => {
  ...
  app.delete(
    ...
    { preHandler: [...adminOnly, validate({ params: userRoleParamsSchema })] },
    async (request, reply) => {
