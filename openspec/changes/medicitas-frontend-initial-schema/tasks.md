...
- [ ] 12.8 Verificar pipeline completo push→deploy: un commit de prueba en `main` genera deployment del API en Render y de la web en Vercel; comprobar login real de un usuario sembrado contra producción (incluyendo cold start de ~30-60 s tras inactividad)
