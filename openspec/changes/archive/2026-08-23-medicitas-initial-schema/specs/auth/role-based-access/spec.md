...
El sistema DEBE asignar roles a usuarios y mantener estado del rol (activo/inactivo).
...
El sistema DEBE aplicar permisos en todos los endpoints API basándose en roles de usuario.
...
El sistema DEBE mantener catálogo de roles disponibles con descripciones.
