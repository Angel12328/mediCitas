# patients/management Specification
...
El sistema SHALL crear registros de pacientes vinculados a cuentas de usuario con información médica.
...
El sistema SHALL permitir a pacientes ver y actualizar su información médica.
...
El sistema SHALL almacenar y recuperar nombre y número de teléfono de contacto de emergencia.
