# doctors/specialties Specification
...
El sistema SHALL mantener catálogo de especialidades médicas con estado activo/inactivo.
...
El sistema SHALL permitir activación/desactivación de especialidades.
